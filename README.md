...
Some OpenXR "layers" may cause issues if they don't support 32-bit (e.g. reshade). But some like the "Compatibility layer for OculusXR plugin" seem to work fine.
